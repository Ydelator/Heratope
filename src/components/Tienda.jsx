    ...
    <div className='container-tienda'>
      <div className='container-items'>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 1, name: 'BLEU DE CHANEL', price: 160000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 2, name: 'N°5', price: 157000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <span className='precio-item'>$157.000</span>
          <button className='btn-item' onClick={()=> addToCart({id: 3, name: 'COCO MADEMOISELLE', price: 157000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <span className='precio-item'>$157.000</span>
          <button className='btn-item' onClick={()=> addToCart({id: 4, name: 'GABRIELLE CHANEL', price: 157000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 5, name: 'DYLAN BLUE POUR', price: 393000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 6, name: 'EROS FLAME', price: 575300})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 7, name: 'EROS EDP', price: 575000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 8, name: 'SANTAL BOISÉ', price: 1740000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 9, name: 'DIESEL', price: 297000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 10, name: 'Nautica', price: 131990})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 11, name: 'Al Haramain', price: 418000})}>Agregar al carrito</button>
        </div>
        <div className="item">
          ...
          <button className='btn-item' onClick={()=> addToCart({id: 12, name: 'PURPLE DREAM', price: 63990})}>Agregar al carrito</button>
        </div>
        ...
        <div className="carrito">
          ...
          <ul>
            {cartItems.map((item) => (
              <li key={item.id}>
                {item.name} - ${item.price} - Cantidad: {item.price * item.quantity}
